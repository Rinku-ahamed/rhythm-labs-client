...
const Footer = () => {
  return (
    <>
      <footer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 px-6 pt-10 pb-16 bg-[#141b29] text-white mt-10">
        <div>
          <Link to="/" className="normal-case text-3xl font-bold text-white">
            Rhythm <span className="text-[#ef672a]">Labs</span>
          </Link>
          <p className="mt-5 text-slate-300">
            Rhythm Labs is a meticulously crafted website dedicated to the art
            of teaching music. Our purpose is to provide a comprehensive and
